...
/**
 * Servlet implementation class SelectOrdersBySid
 */
@WebServlet("/SelectOrdersBySid")
public class SelectOrdersBySid extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		o=OrdersDao.SelectOrdersBySid(sid);

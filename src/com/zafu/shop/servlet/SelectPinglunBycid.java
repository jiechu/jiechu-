...
/**
 * Servlet implementation class SelectPinglunBycid
 */
@WebServlet("/SelectPinglunBycid")
public class SelectPinglunBycid extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList< Pinglun> p=new ArrayList<Pinglun>();
		int cid=Integer.parseInt(request.getParameter("cid"));
		p=PinglunDao.SelectPinglunBycid(cid);
		PrintWriter w=response.getWriter();
		w.write(JSONArray.toJSONString(p));
		flush(w);
		close(w);
	}

...
/**
 * Servlet implementation class SelectOrdersByCid
 */
@WebServlet("/SelectOrdersByCid")
public class SelectOrdersByCid extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		o=OrdersDao.SelectOrdersByCid(cid);

...
/**
 * Servlet implementation class SelectOrdersBySidAndOstate
 */
@WebServlet("/SelectOrdersBySidAndOstate")
public class SelectOrdersBySidAndOstate extends HttpServlet {
     ...
     */
    public SelectOrdersBySidAndOstate() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		o=OrdersDao.SelectOrdersBySidAndOstate(sid,ostate);

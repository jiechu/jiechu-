...
/**
 * Servlet implementation class SelectSeller
 */
@WebServlet("/SelectSeller")
public class SelectSeller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Seller> rs=new ArrayList<Seller>();
		rs=SellerDao.SelectSeller();
		PrintWriter writer=response.getWriter();
		writer.write(JSONArray.toJSONString(rs));
		flush(writer);
		close(writer);
	}
